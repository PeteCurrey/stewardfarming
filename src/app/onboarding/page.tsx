...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 bg-slate-50 text-slate-900 flex flex-col justify-center">
      <div className="max-w-3xl mx-auto w-full space-y-8">
        
        {/* Progress header */}
        <div className="space-y-3 text-center">
          <div className="inline-flex items-center space-x-2">
            <Badge variant="forest">Farm Onboarding</Badge>
          ...
          <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden max-w-xs mx-auto">
            <div
              className="bg-forest-900 h-full transition-all duration-300 rounded-full"
        ...
        {/* STEP 1: Farm Type */}
        {step === 1 && (
          <div className="p-8 space-y-6 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="space-y-1 text-center sm:text-left">
              <h1 className="text-2xl sm:text-3xl font-serif font-medium text-slate-900">
                1. Select Your Primary Farm Enterprise
              </h1>
              <p className="text-xs sm:text-sm text-slate-600">
                This configures which dedicated specialist advisor leads your daily briefings and decision support.
              </p>
            </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "bg-white border-forest-800 shadow-sm ring-1 ring-forest-800"
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <h3 className="font-serif font-medium text-base text-slate-900">
                        {item.label}
                      </h3>
                    ...
                    <div className="pt-2 border-t border-slate-100 text-xs font-medium text-forest-800">
        ...
        {step === 2 && (
          <div className="p-8 space-y-6 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-600">
                Used to lock 1.1km Met Office radar forecasts, RPA Ordnance Survey parcels, and NVZ catchment rules.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg bg-white border border-slate-300 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-forest-700"
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3.5 py-2.5 rounded-lg bg-white border border-slate-300 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-forest-700"
                    />
                  </div>
                </div>
        ...
        {step === 3 && (
          <div className="p-8 space-y-6 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="space-y-1 text-center sm:text-left">
              <h1 className="text-2xl sm:text-3xl font-serif font-medium text-slate-900">
                3. Select Active Farm Enterprises
              </h1>
              <p className="text-xs sm:text-sm text-slate-600">
                Calibrates spray window thresholds, livestock calendars, and statutory reporting schedules.
              </p>
            </div>
              ...
              {ENTERPRISE_OPTIONS[farmType].map((item) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "p-3.5 rounded-lg border text-left text-sm transition-all flex items-center justify-between",
                      isSelected
                  ...
                  >
                    <span>{item}</span>
                    {isSelected && <CheckCircle2 className="w-4 h-4 text-emerald-400 ml-2" />}
                  </button>
                );
              })}
            </div>

            <div className="p-4 rounded-lg bg-slate-50 border border-slate-200 text-xs text-slate-600 flex items-start space-x-3">
        ...
        {step === 4 && (
          <div className="p-8 space-y-6 rounded-2xl border border-slate-200 bg-white shadow-sm text-center sm:text-left">
            <div className="text-center space-y-2">
              <Badge variant="forest" size="md">Advisory Pairing Complete</Badge>
            ...
            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="space-y-2 text-left">
                ...
                <p className="text-xs text-slate-600 italic border-l-2 border-amber-400 pl-3 leading-relaxed">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-200">
              ...
              >
                {loading ? "Initialising Dashboard..." : "Enter Farm Dashboard"}
